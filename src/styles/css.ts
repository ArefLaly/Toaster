...
.toastra__confirm-card[data-type="error"] { --toastra-accent: var(--toastra-error); }
.toastra__confirm-card[data-type="warning"] { --toastra-accent: var(--toastra-warning); }
.toastra__confirm-card[data-type="info"] { --toastra-accent: var(--toastra-info); }
.toastra__confirm-card[data-type="loading"] { --toastra-accent: var(--toastra-progress); }
.toastra__confirm-card[data-type="default"] { --toastra-accent: var(--toastra-foreground); }
